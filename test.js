...
for(let i=0;i<30;i++){
    var im= md.products[i].images[0];
    var gr=document.getElementsByClassName("card")[i].getElementsByTagName("img")[0];
    gr.setAttribute("src",im);
    var gr1=document.getElementsByClassName("card")[i].getElementsByTagName("span")[0];
    var gr2=document.getElementsByClassName("card")[i].getElementsByTagName("span")[1];
    var gr3=document.getElementsByClassName("card")[i].getElementsByTagName("span")[2];
    gr1.innerHTML= md.products[i].id;
    gr2.innerHTML= md.products[i].title;
    gr3.innerHTML= md.products[i].description;
}
var exa=document.getElementsByClassName("col")[1];
exa.style.display="none";
exa.style.display="block";
var myvar=document.forms.sb;
myvar.onsubmit= function(){
    if(myvar.name.value != ""){
    for(let j=0;j<30;j++){
       //alert(md.products[j].title);
        var s1=myvar.name.value;
        var s2=md.products[j].title;
        var s3=myvar.name.value;
        var s4=md.products[j].description;
        ...
        if(s1==s2  || s3==s4){
           ...
           // alert(md.products[j].title);
            ...
            var exa=document.getElementsByClassName("col")[j];
            //console.log(exa);
            exa.style.display="none";
             //alert(md.products[2].title);
            //exa.style.display="none";
        ...
        for(let k=0;k<30;k++){
            var axe=document.getElementsByClassName("col")[k];
